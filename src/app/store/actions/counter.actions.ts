...
export const STORE_REMOVE_RESULT = "STORE_REMOVE_RESULT";
...
export class onStoreRemoveResult implements Action{
  readonly type: string = STORE_REMOVE_RESULT;
  constructor(public value : number){
    console.log("[STORE REMOVE RESULT]")
  }
}
...
export type CounterAction = onAddCounter | onSubtractCounter | onStoreResult | onStoreRemoveResult
